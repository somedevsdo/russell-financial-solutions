          ...
          <div className="col-md-8">
            <div className="text-row">
              <p className="text-row__paragraph">
                So who are we? Click or hover on the profile pictures below to see what we’re about
                and what we are into. We are real people just like you.
              </p>
              <p className="text-row__paragraph">
        ...
        <div className="row">
          <div className="col-md-6 col-xl-4">
            ...
            >
              ...
              <p>
                Customer service and client experience is key to Glen&apos;s core values and this is
                filtered through the team at RFS which is evident in client reviews which he prides
                the business on.
              </p>
              <p>
                Glen has always been a local lad and loves spending time with his family and friends
                including his wife and young son which keep him very busy. Not to mention his very
                demanding dog that takes up a lot of his spare time walking. In Glen&apos;s words he
          ...
          <div className="col-md-6 col-xl-4">
            ...
            >
              ...
              <p>
                ...
                100 brokers, ensuring they followed the correct rules and FCA regulations as well as
                setting a high bench mark for customer satisfaction.
              </p>
              <p>
          ...
          <div className="col-md-6 col-xl-4">
            ...
            >
              ...
              <p>
                Ed has worked for a large bank for just under eight years which started with helping
                customers with their everyday banking needs but quickly developed a passion for
                mortgages after being able to refer customers on a regular basis.
              </p>
              <p>
              ...
              <p>
                In his spare time Ed loves to lift weights and enjoys long walks with his Dog in the
                countryside with the odd game of golf.
              </p>
            </Profile>
          </div>
          ...
          <div className="col-md-6 col-xl-4">
            ...
            >
              <p>
                ...
                support for the brokers, liaising with solicitors and updating clients amongst many
                other things. The list is endless as I’m sure she would agree.
              </p>
              <p>
                Out of work Maxine is currently Social Secretary of a large local WI group, Broadway
                Belles. Where she is busy organising a variety of social &amp; charity events for
                110 members, from visits to water treatment plants to cocktail making. As a group
                they are currently supporting a local charity, Age Concern Westcliff, which provides
          ...
          <div className="col-md-6 col-xl-4">
            ...
            >
              <p>
                Nicole is a Chartered Accountant with 13 years accountancy, management and business
                strategy experience.
              </p>
              <p>
                After graduating with a degree in Aerospace Engineering she went on to work in an
                accountancy practice and studied towards her ACCA qualification. Once qualified she
                left practice life and started her career in the commercial sector. With a passion
                for engineering she managed to grow within a leading global automotive engineering
                company and earned her place on the senior management team. Guiding the UK finance
                department through systems upgrades, times of economic uncertainties and rapid
                company growth.
              </p>
              <p>
          ...
          <div className="col-md-6 col-xl-4">
            ...
            >
              <p>
                ...
                five years as a Careers Advisor where she obtained a Level 4 Diploma in Information,
                Advice and Guidance. Along with Maxine, Kelly provides admin support for the
                brokers.
              </p>
              <p>
                Kelly loves making things from marshmallows (yes, you can really make them!) to
                cakes, from painting to sewing. She has 2 young boys who keep her very busy as well
                as a Great Dane whom she enjoys walking with in the local countryside.
              </p>
            </Profile>
          </div>
